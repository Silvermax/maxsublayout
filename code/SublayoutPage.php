...
class SublayoutPage extends Page
{
    ...
    public static $description = 'Redirects to parent page. This page is here only for holding some content. Doest have own page with url...';
